...
'''
# cursor.execute(createProductViewTable)
...
'''
# cursor.execute(createOrderItemTable)
...
'''
# cursor.execute(createCategoriesTable)
...
# Iterate through each line of randomInserts:
# for line in randomInserts.splitlines():
#     cursor.execute(line)
#     mydb.commit()
#------------------------------------------------------
